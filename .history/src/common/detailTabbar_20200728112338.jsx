                                                ...
                                                <div className="reply">
                                                    <div className="left">
                                                        <div className="avatar">
                                                            <img src={replyItem.commentUser.avatar} alt=""/>
                                                        </div>
                                                    </div>
                                                    <div className="right">
                                                        <div className="name-time">
                                                            <span className="write-name">{replyItem.commentUser.nickname}</span>
                                                            <span className="time">{replyItem.createTime.split(' ')[0]}</span>
                                                        </div>
