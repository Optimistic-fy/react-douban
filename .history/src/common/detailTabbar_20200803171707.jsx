...
import { clickPraise, cancelPraise } from './store/actionCreaters'

@withRouter
@connect(
    state => state,
    { clickPraise, cancelPraise}
)
...
class DetailTabbar extends React.PureComponent{
    ...
    render(){
        ...
        const { info, commentlist, index } = this.props
                    ...
                    <div className="icont">
                        <div className="origin-icon">
                            ...
                            <span 
                                ...
                                onClick={() => this.handlePraise(info.snowflakeId, info.praise, index)}
                                >
                                    &#xe61b;
