...
class Team extends React.PureComponent{
    ...
    componentDidMount () {
        ...
        if (!localStorage.getItem('list')) {
            ...
            let list = JSON.parse(localStorage.getItem('listSearch'))
            console.log('listSearch', list)
            setTimeout(() => {
                this.setState({
                    dataSource: this.state.dataSource.cloneWithRows(list.dataSource),
                    height: hei,
                    refreshing: false
                });
                this.props.changeLoading(false)
    ...
    handleClickDetail = (ind, id) => {
        ...
        localStorage.setItem('list', JSON.stringify(this.props.recomList))
