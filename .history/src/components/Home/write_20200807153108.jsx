...
import { changeInitialPage, getInputValue, uploadImg } from './store/actionCreaters'

@withRouter
@connect(
    state => state.Home,
    {changeInitialPage, getInputValue, uploadImg}
)
...
class Write extends React.PureComponent{
    ...
    handleRelease () {
        ...
        // 发送请求  上传图片
        this.props.uploadImg(files, formData)
    }
