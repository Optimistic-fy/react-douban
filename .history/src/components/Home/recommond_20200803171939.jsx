...
import { getReList, clickPraise, cancelPraise } from './store/actionCreaters'
...
@connect(
    state => state,
    {getReList, clickPraise, cancelPraise, changeLoading}
)
                            ...
                            <li key={item.snowflakeId}>
                                <div className="recommond">
                                    ...
                                    <div className="bottom">
                                        ...
                                        <Link to={`/infoDetail/${item.snowflakeId}/${index}`}>
