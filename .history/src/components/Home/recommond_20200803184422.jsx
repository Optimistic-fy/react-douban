...
import { getReList, clickPraise, datas } from './store/actionCreaters'
...
class Recommond extends React.PureComponent{
    ...
    componentDidMount(){
        ...
        let datas = localStorage.getItem('persist:root')
        if (datas) {
            this.props.dispatch(getRecommList(datas.recomList))
        } else {
