...
class Recommond extends React.PureComponent{
    ...
    componentDidMount(){
        ...
        this.props.getReList(this.state.search).then(() => {
            console.log('this.props.Home.recomList', this.props.Home.recomList)
            this.props.changeLoading(false)
            if (this.props.Home.recomList && this.props.Home.recomList.length > 0 ) {
                this.initialScroll()
            }
        })
