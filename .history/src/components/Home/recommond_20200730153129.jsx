...
class Recommond extends React.PureComponent {
        ...
        handleClickPicture(list, index) {
            this.props.parent.setPriview(this, {
                list,
                index,
                show: true
            })
                ...
                ref = "downRefresh" > 下拉刷新 < /div> {
                    recomList ? recomList.map((item) => {
                                return ( <
                                    ...
                                    span className = "iconfont share" > & #xe708; < /span> <
                                    /div> <
                                    div className = "recommon-content" > {
                                        item.themeTitle ? < div className = "hot" >
                                        <
                                        span className = "icon" > # < /span> <
                                        span className = "hot-tittle" > {
                                            item.themeTitle
                                        } < /span> <
                                        /div> : null} <
                                        Link to = {
                                            `/infoDetail/${item.snowflakeId}`
                                        } >
                                        <
                                        div className = "text" >
                                        <
                                        ...
                                        ul > {
                                            item.imageList ? item.imageList.map((image, index) => {
                                                return ( <
                                                    li onClick = {
                                                        () => this.handleClickPicture(item.imageList, index)
                                                    }
                                                    key = {
                                                        index
                                                    } >
                                        ...
                                        <
                                        span className = "like iconfont" > & #xe61b; < span className = "like-count" > {
                                            item.praiseCount
                                        } < /span></span >
                                        <
                                        Link to = {
                                        ...
                                        <
                                        span className = "comment iconfont" > & #xe69a; < span className = "comment-count" > {
                                            item.replyUserCount
                                        } < /span></span >
                                        <
                                        /Link> <
                                        span className = "reprint iconfont" > & #xe62e; < /span> <
                                        /div> <
                                        /div> <
                                        /li>
                                    )
