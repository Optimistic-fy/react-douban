...
class Recommond extends React.PureComponent{
    ...
    componentDidMount(){
        ...
        // this.initialScroll()
        console.log('Scroll', this.refs.scroll.getScrollObj())
    ...
    initialScroll = () => {
        if (!scroll) {
            ...
            scroll.on('scroll', (position) => {
                ...
                } else if(position.y < 60 && position.y > 0) {
        ...
        if (localStorage.getItem('scrollHeight') != null) {
            scroll.scrollTo(0, localStorage.getItem('scrollHeight'))
            scroll.refresh()
        }
    }
    ...
    render () {
        ...
        return(            
            <div className="recom" id="recList">
                <Scroll click={true} ref='scroll' >
                    <ul>
