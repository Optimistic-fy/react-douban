                            ...
                            <li key={item.snowflakeId}>
                                <div className="recommond">
                                    ...
                                    <div className="bottom">
                                        {
                                            item.praise ? <span className="like iconfont" onClick={this.handlePraise}>&#xe61b;<span className="like-count">{item.praiseCount}</span></span> : <span className="like iconfont" onClick={this.handlePraise}>&#xe61b;<span className="like-count">{item.praiseCount}</span></span>
                                        }
                                        <Link to={`/infoDetail/${item.snowflakeId}`}>
