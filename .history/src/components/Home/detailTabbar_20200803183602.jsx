...
class DetailTabbar extends React.PureComponent{
    ...
    render(){
        ...
        const tabs = [
            ...
            { title: <Badge text={info.praiseList.length}>赞</Badge> },
        ...
        const sidebar = (
            <Tabs 
                ...
                <div className="prase-list">
                    <ul className="prase">
                        {info.praiseList ? info.praiseList.map((item) => {
                            return (
                ...
                >
                    <div className="icont">
                        <div className="origin-icon">
                            ...
                            <span 
                                style={{ width: clickReply ? '15%' : '33%', display: !clickWriteReply ? 'inline-block' : 'none', color: info.praise ? '#03b920d9' : '' }}
                                className="iconfont"
                                onClick={() => this.handlePraise(info.snowflakeId)}
                            >
                                    &#xe61b;
                                    <span className="like-count">{info.praiseCount}</span>
                            </span>
                            <span 
